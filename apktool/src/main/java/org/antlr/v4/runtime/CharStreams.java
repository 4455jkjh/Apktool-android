...
public final class CharStreams {
	 ...
	 */
	public static CharStream fromFile(File path) throws IOException {
	 ...
	 * Reads the entire contents of the file into the result before returning.
	 */
	public static CharStream fromFile(File path, Charset charset) throws IOException {
		InputStream is = new FileInputStream(path);
		try {
			return fromStream(is, charset, path.length());
		} finally {
			is.close();
		}
	}
