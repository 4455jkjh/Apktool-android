...
public class Androlib {
	...
	throws AndrolibException {
        try {
            MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_RAW_FILE, filename);
	...
	throws AndrolibException {
        try {
            ...
            OS.rmdir(smaliDir);
            smaliDir.mkdirs();
            MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_BAKSMALI, filename);
	...
	throws AndrolibException {
        try {
            MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_RAW_MANIFEST);
	...
	throws AndrolibException {
        try {
            MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_RAW_RESOURCES);
	...
	throws AndrolibException {
        MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_ASSETS_AND_LIBS);
        try {
	...
	throws AndrolibException {
        MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_UNKNOWN_FILES);
	...
	throws AndrolibException {
        MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_ORIGINAL_FILES);
	...
	throws AndrolibException {
        try {
			...
			MetaInfo load = MetaInfo.load(in);
			in.close();
			return load;
	...
	throws BrutException {
        MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_SHOW_VERSION, Androlib.getVersion());
        ...
        MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_BUILT_APK);
    }
	...
	throws AndrolibException {
        ...
        if (apkOptions.forceBuildAll || isModified(working, stored)) {
            MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_TWO_ARG_FILE, appDir, filename);
            try {
	...
	throws AndrolibException {
        ...
        if (! apkOptions.forceBuildAll) {
            MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_CHECK_SOURCES);
        }
        if (apkOptions.forceBuildAll || isModified(smaliDir, dex)) {
            MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_SMALI_FOLDER, folder, filename);
            dex.delete();
	...
	throws AndrolibException {
        try {
            ...
            if (! apkOptions.forceBuildAll) {
                MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_CHECK_RESOURCES);
            }
	...
	throws AndrolibException {
        try {
            ...
            if (apkOptions.forceBuildAll || isModified(newFiles(APP_RESOURCES_FILENAMES, appDir),
                ...
                MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_BUILD_RESOURCES);
	...
	throws AndrolibException {
        try {
            File apkDir = new File(appDir, APK_DIRNAME);
            MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_RAW_ANDROIDMANIFEST);
	...
	throws BrutException {
        try {
            ...
            if (apkOptions.forceBuildAll || isModified(newFiles(APK_MANIFEST_FILENAMES, appDir),
                ...
                MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_BUILD_ANDROIDMANIFEST);
    ...
    public void buildLibrary(File appDir, String folder) throws AndrolibException {
        ...
        if (apkOptions.forceBuildAll || isModified(working, stored)) {
            MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_LIBS, folder);
            try {
                OS.rmdir(stored);
        ...
        if (apkOptions.copyOriginalFiles) {
            ...
            if (originalDir.exists()) {
                try {
                    ...
                    if (in.containsDir("META-INF")) {
                        MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_META);
	...
	throws AndrolibException {
        if (meta.unknownFiles != null) {
            MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_COPY_UNKNOWN_FILES_DIR);
	...
	throws BrutException, IOException {
        ...
        for (Map.Entry<String,String> unknownFileInfo : files.entrySet()) {
            ...
            MessageUtil.fine(LOGGER, MessageUtil.COPY_FILE_WITH_METHOD, unknownFileInfo.getKey(), method);
    ...
    public void buildApk(File appDir, File outApk) throws AndrolibException {
        MessageUtil.info(LOGGER, MessageUtil.ANDROLIB_BUILD_APK);
        if (outApk.exists()) {
            outApk.delete();
        } else {
